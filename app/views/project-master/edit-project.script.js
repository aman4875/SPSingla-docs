$(document).ready(function () {
    ...
    $("#awardedModal").on("mousedown", function (e) {
        if ($(e.target).hasClass("modal")) {
            closedByBackdropClick = true;
        }
    });

    $("#awardedModal").on("hide.bs.modal", function (e) {
...
$("#doc_selected_site").on("change", function () {
    ...
    if ($("#awardedModal").hasClass("show")) {
        $("#awardedModal").modal("hide");
    }
});
